...
def timing():       #siempre entra en el evento tipo 2
    ...
    if next_event_type == 0:
        #lista de eventos vacia, se detiene la simulacion
...
def initialize():
    ...
    sim_time = 0                                # inicializa el reloj de simulacion
...
def evaluate():
    ...
    if inv_level < smalls:                                            #evalua si el stock es menor al minimo
    ...
    time_next_event[4] = sim_time + 1                                 #se pone en la lista de eventos la sig evaluacion
